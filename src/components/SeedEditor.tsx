          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <div>
                ...
                <input type="number" className="w-full rounded-md border border-input bg-background px-3 py-2" value={stockQty} onChange={e=>setStockQty(Number(e.target.value)||0)} />
              </div>
            </div>
